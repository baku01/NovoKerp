...
export const handlers = [
    ...
    http.get('*/chamadaProcedure', ({ request }) => {
        ...
        switch (procName) {
                ...
                return HttpResponse.json([
                    {
                        id_soli: 1,
                        so_data: '2024-12-07',
                        cl_orig: 'Obra Central - Shopping',
                        cl_dest: 'Obra Norte - Residencial',
                        so_situ: 'Pendente',
                        so_qtit: 5
                    }
                ]);
            ...
            case 'pesquisaSituacoes':
                return HttpResponse.json([
                    { id_situ: 1, st_desc: 'Pendente' },
                    { id_situ: 2, st_desc: 'Aprovado' },
                    { id_situ: 3, st_desc: 'Rejeitado' },
                    { id_situ: 4, st_desc: 'Concluído' }
                ]);
